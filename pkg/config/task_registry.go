...
type TaskConfig struct {
	TerminalRetentionHours int `json:"terminal_retention_hours,omitempty" env:"MINTCLAW_TASK_REGISTRY_TERMINAL_RETENTION_HOURS"`
	MaxRecords             int `json:"max_records,omitempty"              env:"MINTCLAW_TASK_REGISTRY_MAX_RECORDS"`
	MaxEvents              int `json:"max_events,omitempty"               env:"MINTCLAW_TASK_REGISTRY_MAX_EVENTS"`
	MaxSnapshotBytes       int `json:"max_snapshot_bytes,omitempty"       env:"MINTCLAW_TASK_REGISTRY_MAX_SNAPSHOT_BYTES"`
}
