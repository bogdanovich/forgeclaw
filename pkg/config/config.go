...
type ResponseFooterConfig struct {
	Enabled bool `json:"enabled" env:"PICOCLAW_AGENTS_DEFAULTS_RESPONSE_FOOTER_ENABLED"`
}
...
type RichMessagesConfig struct {
	Enabled bool `json:"enabled" yaml:"-" env:"PICOCLAW_CHANNELS_TELEGRAM_RICH_MESSAGES_ENABLED"`
}
