...
func (a *channelManagerAdapter) SendMessageProvisional(ctx context.Context, msg bus.OutboundMessage) error {
...
func (a *channelManagerAdapter) SendMediaProvisional(ctx context.Context, msg bus.OutboundMediaMessage) error {
