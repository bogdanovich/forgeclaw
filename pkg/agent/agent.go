...
const (
	...
	metadataKeyDefaultModel    = "default_model_name"
	metadataKeyUsageInput      = "usage_input_tokens"
	metadataKeyUsageOutput     = "usage_output_tokens"
	metadataKeyUsageTotal      = "usage_total_tokens"
