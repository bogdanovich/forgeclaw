...
func newCaptureStreamer() (*mintclawStreamer, *map[string]any) {
	var last map[string]any
	ch := &MintClawChannel{}
	ch.broadcastFn = func(_ context.Context, chatID string, msg MintClawMessage) error {
		last = msg.Payload
		return nil
	}
	s := &mintclawStreamer{channel: ch, chatID: "c1"}
	return s, &last
}
